""" Provide a version for the msalign library.
...
Attributes:
    __version__:
        The full version string for this installed msalign library
...
def get_config():
    ...
    cfg.style = "pep440"
    cfg.tag_prefix = ""
    cfg.parentdir_prefix = "imimspy-"
    cfg.versionfile_source = "imimspy/_version.py"
    cfg.verbose = False
    return cfg
